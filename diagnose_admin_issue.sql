-- Diagnostic query to understand the admin user setup
-- Run this to see what's in your admin_users table and identify the issue
...
-- Check all admin users (if any exist)
SELECT 
  'Admin User Details' as check_type,
  ROW_NUMBER() OVER (ORDER BY granted_at) as count,
  CONCAT(
    'User: ', user_id, 
    ', Org: ', organization_id,
    ', Level: ', admin_level,
